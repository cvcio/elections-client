						...
						<v-container grid-list-md>
							<v-layout wrap>
								<v-flex xs12>
									...
									<p class="my-3">Η συγκεκριμένη λειτουργία της πλατφόρμας απευθύνεται <strong>μόνο</strong> σε Δημοσιογράφους. Παρακαλούμε πριν συνεχίσετε βεβαιωθείτε ότι διαβάσατε τους <a href="/legal" target="_blank">Όρους Χρήσης</a> τον οποίο θα κληθείτε να αποδεχθείτε στο επόμενο στάδιο.</p>
